# UI-тесты MTS: расширение покрытия

Extended Selenium tests for service forms and the payment iframe.

Расширение Lesson_9: плейсхолдеры четырёх услуг, атрибуты логотипов, сумма и телефон на следующем шаге, подписи полей карты и иконки в iframe. Девять тестовых методов.
...
Selenium 4.27.0, JUnit 5.10.0, Page Object, WebDriverManager, Gradle.
...
```bash
git clone --branch Lesson_10 --single-branch https://github.com/rootofevi1/Aston_AQA_50.git
cd Aston_AQA_50
./gradlew test
```
