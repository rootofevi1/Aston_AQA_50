...
Object-oriented Java examples with products and a park model.
...
- [Исходный код](src/main/java/lesson_2/)
...
```bash
git clone --branch Lesson_2 --single-branch https://github.com/rootofevi1/Aston_AQA_50.git
cd Aston_AQA_50
./gradlew classes
java -cp build/classes/java/main lesson_2.Main
```
